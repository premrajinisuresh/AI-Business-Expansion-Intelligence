/* ============================================================
   Enrichment Script
   Optimized & Safe: Uses a streamlined 2-pass phone hunt to 
   prevent API rate-limiting, timeouts, and workflow freezes.
   ============================================================ */
...
// Streamlined 2-Pass Phone Hunt (Safe for Free-Tier Quotas)
async function huntPhoneNumberViaSearch(company) {
  ...
  // Pass 2: Directory fallback (only if Pass 1 found nothing)
