...
const CONFIG = {
  ...
  FROM_EMAIL: "smartpos.systems@gmail.com",
  EMAIL_DELAY: 1000,
...
const CATEGORY_RULES = [
  ...
  {
    key: "petrolbunks",
    match: ["petrol", "fuel", "bunk", "gas station", "fuel station"],
    subject: (c) => `Highway Corner Plot for ${c.Company} — Madurai Junction`,
    pitch:
      "Fuel retail depends entirely on highway visibility and easy turn-in access. This corner plot sits directly at a busy Madurai highway junction — a strong candidate for a new fuel station or highway service point."
  },
  {
    key: "resorts",
