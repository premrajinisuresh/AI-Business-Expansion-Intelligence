...
const SEARCH_CATEGORIES = [
  { 
    ...
    query: "resorts hotels tourism property developers Alagar Kovil Road Madurai",
  ...
  { 
    ...
    query: "religious trusts charitable institutions mandapam land purchase Madurai",
  ...
  { 
    ...
    query: "convention center wedding hall development Alagar Kovil Road Madurai",
  ...
  { 
    ...
    query: "service apartments extended stay real estate developers Madurai",
  ...
  { 
    ...
    query: "boutique commercial complex retail mall developers Madurai",
  ...
  { 
    ...
    query: "multi-specialty hospital branch healthcare expansion Madurai",
  ...
  { 
    ...
    query: "educational institution campus extension training center Madurai",
...
async function executeMatrixSearch(currentRotationIndex) {
  ...
  const prompt = `List 10 distinct, verified corporate entities, institutions, or trusts matching: "${targetQuery}". Output strictly as a clean, plain text list with one entity name per line. No introductory or concluding text.`;
